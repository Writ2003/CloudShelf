...
const PopularBook = () => {
  return (
    <div className='h-full bg-blue-950 px-3 py-12'>
        <div className='flex flex-col items-center gap-3'>
            ...
            <div className='grid grid-cols-3 text-white/75 text-[12px] text-center justify-items-center gap-3'>
                <div className='border-r border-white/75 flex flex-col gap-1 align-middle pr-3'>
                    <div>320</div>
                    <div>Pages</div>
                </div>
                <div className='border-r border-white/75 flex flex-col gap-1 pr-3'>
                    <div>643</div>
                    <div>Ratings</div>
                </div>
            ...
            <p className='text-[12px] text-white/75 m-3 h-40 overflow-hidden w-44'>
            ...
            <div className='text-white bg-blue-700 px-6 py-3 rounded-lg'>
