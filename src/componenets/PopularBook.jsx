...
const PopularBook = () => {
  return (
    <div className='h-full bg-blue-950 lg:px-3 py-12'>
        <div className='flex flex-col items-center gap-3'>
            ...
            <div className='px-1 lg:px-0 grid grid-cols-3 text-white/75 text-[12px] text-center justify-items-center lg:gap-3'>
                <div className='border-r border-white/75 flex flex-col gap-1 align-middle pr-1 lg:pr-3'>
                    <div>320</div>
                    <div>Pages</div>
                </div>
                <div className='border-r border-white/75 flex flex-col gap-1 pr-1 lg:pr-3'>
                    <div>643</div>
                    <div>Ratings</div>
                </div>
                <div className='flex flex-col gap-1 pl-1 lg:pl-0'>
                    <div>110</div>
                    <div>Reviews</div>
                </div>
            </div>
            <p className='text-[12px] text-white/75 m-3 h-40 overflow-hidden lg:w-44 w-32'>
            ...
            <div className='text-white bg-blue-700 px-3 py-1.5 lg:px-6 lg:py-3 rounded-lg'>
